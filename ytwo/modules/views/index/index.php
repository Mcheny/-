...
<script>
    ...
    var mysend="<?= Yii::$app->urlManager->createUrl('admin/msg/mysends')?>";
    var goodsList="<?= Yii::$app->urlManager->createUrl('admin/goods/goods_list')?>";
    var userList="<?= Yii::$app->urlManager->createUrl('admin/user/user_list')?>";
    ...
    BUI.use('common/main',function(){
        var config = [
            {id:'1',menu:[
                  ...
                  {text:'商品管理',items:[{id:'33',text:'商品列表',href:goodsList}]},
                  {text:'用户管理',items:[{id:'44',text:'用户列表',href:userList}]},
                ]},
